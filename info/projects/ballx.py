...
class main(Tkinter.Tk):
    ...
    def creating_line(self):
        ...
        self.lin = self.board.create_rectangle(PLAYGROUND_WIDTH - x1, 0,
                                               PLAYGROUND_WIDTH - x1 - 50, 10, tag="l2",
                                               outline="yellow")
        self.line = self.board.create_rectangle(PLAYGROUND_WIDTH - x1 - 50,
                                                0, 0, 10, fill="powder blue", tag="l1",
                                                outline="yellow")
        self.line1 = self.board.create_rectangle(PLAYGROUND_WIDTH, 0,
                                                 PLAYGROUND_WIDTH - x1, 10, fill="powder blue",
